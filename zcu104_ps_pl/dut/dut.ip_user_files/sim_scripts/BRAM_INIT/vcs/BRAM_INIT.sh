...
#                script (type 'BRAM_INIT.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.BRAM_INIT xil_defaultlib.glbl -o BRAM_INIT_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./BRAM_INIT_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key BRAM_INIT_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc BRAM_INIT_simv.daidir vcs_lib c.obj)
