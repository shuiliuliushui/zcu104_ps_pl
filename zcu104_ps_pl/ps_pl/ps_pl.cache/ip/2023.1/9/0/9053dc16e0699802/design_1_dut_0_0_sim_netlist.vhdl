...
begin
  ...
  mnt_cnt_dut(6) <= \<const0>\;
  mnt_cnt_dut(5) <= \<const0>\;
  mnt_cnt_dut(4) <= \<const0>\;
  mnt_cnt_dut(3) <= \<const0>\;
  mnt_cnt_dut(2) <= \<const0>\;
  mnt_cnt_dut(1) <= \<const0>\;
  mnt_cnt_dut(0) <= \<const0>\;
  mnt_fsm_state_dut(2) <= \<const0>\;
  mnt_fsm_state_dut(1) <= \<const0>\;
  mnt_fsm_state_dut(0) <= \<const0>\;
