...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_user_ctrl is
  ...
  attribute SOFT_HLUTNM of \FSM_state[2]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \slv_reg0[7]_i_2\ : label is "soft_lutpair14";
...
\FSM_state[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller_v1_0_S00_AXI_LITE is
  ...
  signal i0_user_ctrl_n_0 : STD_LOGIC;
  signal i0_user_ctrl_n_1 : STD_LOGIC;
  signal i0_user_ctrl_n_12 : STD_LOGIC;
  signal i0_user_ctrl_n_13 : STD_LOGIC;
  signal i0_user_ctrl_n_14 : STD_LOGIC;
  signal i0_user_ctrl_n_15 : STD_LOGIC;
  signal i0_user_ctrl_n_2 : STD_LOGIC;
  signal i0_user_ctrl_n_3 : STD_LOGIC;
  signal i0_user_ctrl_n_4 : STD_LOGIC;
  signal i0_user_ctrl_n_47 : STD_LOGIC;
  signal i0_user_ctrl_n_49 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \slv_reg0[31]_i_3\ : label is "soft_lutpair18";
begin
...
i0_user_ctrl: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_user_ctrl
     port map (
      ...
      D(0) => i0_user_ctrl_n_47,
      DUT_finish => DUT_finish,
      E(3) => i0_user_ctrl_n_0,
      E(2) => i0_user_ctrl_n_1,
      E(1) => i0_user_ctrl_n_2,
      E(0) => i0_user_ctrl_n_3,
      \FSM_state_reg[3]_0\ => i0_reset_asyn_syn_n_0,
      Q(0) => slv_reg0_0(0),
      SR(0) => i0_user_ctrl_n_49,
      \axi_awaddr_reg[2]\(3) => i0_user_ctrl_n_4,
      \axi_awaddr_reg[2]\(2) => i0_user_ctrl_n_5,
      \axi_awaddr_reg[2]\(1) => i0_user_ctrl_n_6,
      \axi_awaddr_reg[2]\(0) => i0_user_ctrl_n_7,
      ...
      \slv_reg0_vld_reg_reg[1]_0\(3) => i0_user_ctrl_n_12,
      \slv_reg0_vld_reg_reg[1]_0\(2) => i0_user_ctrl_n_13,
      \slv_reg0_vld_reg_reg[1]_0\(1) => i0_user_ctrl_n_14,
      \slv_reg0_vld_reg_reg[1]_0\(0) => i0_user_ctrl_n_15,
      \slv_reg1_reg[7]\(1 downto 0) => p_0_in(1 downto 0),
...
begin
  mnt_FSM_state(3) <= \<const0>\;
  mnt_FSM_state(2) <= \<const0>\;
  mnt_FSM_state(1) <= \<const0>\;
  mnt_FSM_state(0) <= \<const0>\;
  mnt_enable <= \<const0>\;
  mnt_slv_reg0_bit0 <= \<const0>\;
